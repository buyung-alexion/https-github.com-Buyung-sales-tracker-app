...
// Change ShoppingCart color inside the FAB to white
shell = shell.replace(/<ShoppingCart size=\{24\} strokeWidth=\{2\.5\} color="#111827" \/>/g, '<ShoppingCart size={24} strokeWidth={2.5} color="#ffffff" />');
fs.writeFileSync(shellFile, shell);

console.log('MobileShell & index.css updated');
