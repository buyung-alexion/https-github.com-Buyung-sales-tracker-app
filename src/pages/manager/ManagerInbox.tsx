    ...
    <div className="mgr-page" style={{ padding: '0 32px 32px 32px', height: '100%', display: 'flex', flexDirection: 'row', gap: '24px' }}>
      ...
      <div style={{ width: '250px', display: 'flex', flexDirection: 'column', gap: '16px', paddingRight: '16px' }}>
        <button 
          ...
          style={{ width: 'fit-content', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', background: '#2563EB', color: '#fff', border: 'none', padding: '16px 24px', borderRadius: '16px', fontWeight: 500, fontSize: '15px', cursor: 'pointer', transition: 'box-shadow 0.2s', boxShadow: '0 4px 12px rgba(238, 77, 45, 0.2)' }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', marginLeft: '-16px' }}>
          <button 
            ...
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 10px 32px', borderRadius: '0 50px 50px 0', border: 'none', cursor: 'pointer', background: activeView === 'inbox' ? 'rgba(238, 77, 45, 0.1)' : 'transparent', color: activeView === 'inbox' ? '#2563EB' : '#444746', fontWeight: activeView === 'inbox' ? 700 : 500 }}
          ...
          <button 
            ...
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 10px 32px', borderRadius: '0 50px 50px 0', border: 'none', cursor: 'pointer', background: activeView === 'sent' ? 'rgba(238, 77, 45, 0.1)' : 'transparent', color: activeView === 'sent' ? '#2563EB' : '#444746', fontWeight: activeView === 'sent' ? 700 : 500 }}
      ...
      <div style={{ background: '#ffffff', borderRadius: '16px', border: 'none', boxShadow: '0 1px 2px 0 rgba(60,64,67,0.3)', overflow: 'hidden', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        {activeView === 'compose' ? (
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div style={{ padding: '20px 24px', borderBottom: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', gap: '12px' }}>
               <div style={{ background: 'rgba(238, 77, 45, 0.1)', color: '#2563EB', padding: '8px', borderRadius: '8px' }}><Edit3 size={20} /></div>
               <div>
            ...
            <form onSubmit={handleSend} style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '24px' }}>
               ...
               <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '24px', display: 'flex', justifyContent: 'flex-start' }}>
                 <button type="submit" style={{ background: '#2563EB', color: 'white', padding: '12px 32px', border: 'none', borderRadius: '8px', fontWeight: 600, display: 'flex', gap: '10px', alignItems: 'center', cursor: 'pointer', boxShadow: '0 4px 12px rgba(238, 77, 45, 0.2)' }}><Send size={18} /> Kirim Pesan</button>
               </div>
            </form>
          </div>
        ) : activeView === 'sent' ? (
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '32px 40px' }}>
               ...
               <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px' }}>
                 <div style={{ display: 'flex', gap: '12px' }}>
                   <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(238, 77, 45, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2563EB' }}>
                     <User size={20} />
                   </div>
                   <div>
                 ...
                 {activeMessage.details && activeMessage.details.fullText ? (
                   ...
                   <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '24px' }}>
                     ...
                     <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                       <tbody>
                         ...
                         <tr>
                           ...
                           <td style={{ padding: '10px 0', color: '#334155', borderBottom: '1px solid #e2e8f0' }}>: <a href={`tel:${activeMessage.details.noHp}`} style={{ color: '#2563EB', textDecoration: 'none', fontWeight: 500 }}>{activeMessage.details.noHp}</a></td>
                         </tr>
                         <tr>
                     ...
                     <div style={{ marginTop: '24px', display: 'flex', gap: '12px' }}>
                        <button style={{ background: '#2563EB', color: 'white', padding: '10px 24px', border: 'none', borderRadius: '8px', fontWeight: 600, cursor: 'pointer' }}>Lihat Data Utuh</button>
        ...
        <div style={{ display: 'flex', borderBottom: '1px solid #e2e8f0' }}>
          ...
          >
            ...
            {unreadPrimary > 0 && (
              <span style={{ background: 'rgba(238, 77, 45, 0.1)', color: '#2563EB', padding: '2px 8px', borderRadius: '12px', fontSize: '11px', fontWeight: 800 }}>
                {unreadPrimary} baru
              </span>
            )}
          </button>
            ...
            (viewAll ? filteredMessages : filteredMessages.slice((page - 1) * ITEMS_PER_PAGE, page * ITEMS_PER_PAGE)).map((msg) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: '60px', color: '#94a3b8' }}>
                  ...
                  >
                    <Star size={18} fill={msg.isStarred ? '#2563EB' : 'transparent'} color={msg.isStarred ? '#2563EB' : '#cbd5e1'} />
                  </button>
                </div>
